    ...
    <div className={loginDesign.login}>
      ...
      <footer className={loginDesign.footer}>
        ...
        <div className={loginDesign.footImages}>
          <a href={socialHandles.linkedin} target='_blank'><img className={loginDesign.footLogo} src={linkedinImg} alt='LinkedIn Logo' /></a>
          <a href={socialHandles.facebook} target='_blank'><img className={loginDesign.footLogo} src={facebookImg} alt='Facebook Logo' /></a>
          <a href={socialHandles.instagram} target='_blank'><img className={loginDesign.footLogo} src={instagramImg} alt='Instagram Logo' /></a>
          <a href={socialHandles.twitter} target='_blank'><img className={loginDesign.footLogo} src={twitterImg} alt='Twitter Logo' /></a>
        </div> 
