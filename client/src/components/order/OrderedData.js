    ...
    <div className={orderedDataDesign.orderedData}>
      ...
      <footer className={orderedDataDesign.footer} >
        ...
        <div className={orderedDataDesign.footImages}>
          <a href={socialHandles.linkedin} target='_blank'><img className={orderedDataDesign.footLogo} src={linkedinImg} alt='LinkedIn Logo' /></a>
          <a href={socialHandles.facebook} target='_blank'><img className={orderedDataDesign.footLogo} src={facebookImg} alt='Facebook Logo' /></a>
          <a href={socialHandles.instagram} target='_blank'><img className={orderedDataDesign.footLogo} src={instagramImg} alt='Instagram Logo' /></a>
          <a href={socialHandles.twitter} target='_blank'><img className={orderedDataDesign.footLogo} src={twitterImg} alt='Twitter Logo' /></a>
        </div>
