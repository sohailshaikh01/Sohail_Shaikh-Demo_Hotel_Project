    ...
    <div className={passwordModificationDesign.passwordModification}>
      ...
      <footer className={passwordModificationDesign.footer}>
        ...
        <div className={passwordModificationDesign.footImages}>
          <a href={socialHandles.linkedin} target='_blank' rel='noopener noreferrer'><img className={passwordModificationDesign.footLogo} src={linkedinImg} alt='LinkedIn Logo' /></a>
          <a href={socialHandles.facebook} target='_blank' rel='noopener noreferrer'><img className={passwordModificationDesign.footLogo} src={facebookImg} alt='Facebook Logo' /></a>
          <a href={socialHandles.instagram} target='_blank' rel='noopener noreferrer'><img className={passwordModificationDesign.footLogo} src={instagramImg} alt='Instagram Logo' /></a>
          <a href={socialHandles.twitter} target='_blank' rel='noopener noreferrer'><img className={passwordModificationDesign.footLogo} src={twitterImg} alt='Twitter Logo' /></a>
        </div>
