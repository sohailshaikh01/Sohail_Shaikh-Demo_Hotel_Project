    ...
    <div className={specialJuicesDesign.specialJuices}>
      ...
      <footer className={specialJuicesDesign.footer}>
        ...
        <div className={specialJuicesDesign.footImages}>
          <a href={socialHandles.linkedin} target='_blank'><img className={specialJuicesDesign.footLogo} src={linkedinImg} alt='LinkedIn Logo' /></a>
          <a href={socialHandles.facebook} target='_blank'><img className={specialJuicesDesign.footLogo} src={facebookImg} alt='Facebook Logo' /></a>
          <a href={socialHandles.instagram} target='_blank'><img className={specialJuicesDesign.footLogo} src={instagramImg} alt='Instagram Logo' /></a>
          <a href={socialHandles.twitter} target='_blank'><img className={specialJuicesDesign.footLogo} src={twitterImg} alt='Twitter Logo' /></a>
        </div>
